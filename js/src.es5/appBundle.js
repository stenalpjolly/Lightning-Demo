...
var appBundle = function () {
  ...
  function (_lng$Component) {
    _inherits(AssetPoster, _lng$Component);

    function AssetPoster() {
      _classCallCheck(this, AssetPoster);

      return _possibleConstructorReturn(this, _getPrototypeOf(AssetPoster).apply(this, arguments));
    }

    _createClass(AssetPoster, [{
      key: "_init",
      ...
      value: function _states() {
        ...
        /*#__PURE__*/
        function (_this) {
          _inherits(Focused, _this);

          function Focused() {
            _classCallCheck(this, Focused);

            return _possibleConstructorReturn(this, _getPrototypeOf(Focused).apply(this, arguments));
          }
        ...
        /*#__PURE__*/
        function (_this2) {
          _inherits(UnFocused, _this2);

          function UnFocused() {
            _classCallCheck(this, UnFocused);

            return _possibleConstructorReturn(this, _getPrototypeOf(UnFocused).apply(this, arguments));
          }

          _createClass(UnFocused, [{
            key: "$enter",
            value: function $enter() {
              this.patch({
                Poster: {
  ...
  var Metadata = {
    ...
    "results": [{
      ...
      "backdrop_path": "/A702KA1gXlI3hB33hdhwPM708pY.jpg",
      ...
      "poster_path": "/d8KcK1f3Uxj5Rp86d9XQLsG69ZX.jpg"
    }, {
